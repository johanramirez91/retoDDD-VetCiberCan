...
public class DatosAnimalClienteActualizados extends DomainEvent {
    ...
    public DatosAnimalClienteActualizados(AnimalClienteId animalClienteId, Nombre nombre, EdadAnimalCliente edadAnimalCliente, PesoAnimal pesoAnimal, Raza raza) {
        super("sofka.tienda.datosanimalclienteactualizados");
