...
public class DatosVendedorActualizados extends DomainEvent {
    ...
    public DatosVendedorActualizados(VendedorId vendedorId, Email email, Telefono telefono, Nombre nombre, FechaPago fechaPago) {
        super("sofka.tienda.datosvendedoractualizados");
