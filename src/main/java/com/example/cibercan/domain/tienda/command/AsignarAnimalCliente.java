...
public class AsignarAnimalCliente extends Command {
    ...
    public AsignarAnimalCliente(TiendaId tiendaId, AnimalClienteId animalClienteId, Nombre nombre, EdadAnimalCliente edadAnimalCliente, PesoAnimal pesoAnimal, Raza raza) {
